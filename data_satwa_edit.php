            ...
            <div class="col-md-10 px-0">
              <form method="POST" action="satwa_update.php">
                <div class="contact_form-container">
                  <div>
                    <div>
                      <input type="text" name="id_satwa" placeholder=" id_satwa" readonly value="<?php echo $data['id_satwa']?>">
                    </div>
                    <div>
                      <input type="file"  name="gambar" placeholder="  gambar" required value="<?php echo $data['gambar']?>">
                    </div>
					<div>
                      <input type="text"  name="nama" placeholder=" nama" required value="<?php echo $data['nama']?>">
                    </div> 
                    <div>
                      <input type="text"  name="biografi" placeholder="  biografi"  required value="<?php echo $data['biografi']?>">
                    </div>
